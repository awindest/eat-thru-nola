export let dishes = [
    {
      name: "Shrimp Creole",
      image: "/shrimp-creole.png",
      title: "Shrimp Creole with rice.",
...
5. Optional: can add gouda, cheddar, or blue cheese for a little kick!`
    },
    {
      ...
      title: "It is fun to flambe Bananas Foster!",
      recipe: `Serves four and takes about a half of an hour. Have a fire extinguisher at the ready.
      
Ingredients:

1/4 pound of butter or one stick
1 cup of dark brown sugar
2 bananas
2 ounces of banana liquer
4 ounces of 151 rum
a pinch of cinnamon
vanilla ice cream
...
1. Melt butter and add brown sugar to form a creamy paste. Carmelize over medium heat, about 5 - 10 minutes.
2. Stir in banana liqueur, bananas and rum. 
3. Heat, turn off the lights, ignite and flambé. With a ladle, scoop up the flaming liquid, and pour it back into the pan from a distance above the pan.
4. Agitate to keep the flame burning and add a few pinches of voodoo magic (cinnamon) to the flame.
5. Let the flame go out and serve over vanilla ice cream.`
    },
    {
      name: "Jambalaya",
      image: "/jambalaya.png",
...
1 pound ham slice, cubed (size of a sugar cube)
1 pound of andouille sausage, coin sliced
1 pound of chicken breasts, cut into bite-size pieces, par boiling makes it easier to cut
Optional: 1 pound of small peeled raw shrimp, sprinkled with Creole seasoning
5 large onions, diced
1 - 2 bell peppers, diced
1 bunch of celery, diced
1 bunch of green onions, thinly sliced
1 entire pod of garlic, minced
...
2b. Brown diced ham in the Andouille grease and put aside.
2c. Do the same with the chicken pieces and put aside.
3a. On medium to low heat, sauté bell pepper and celery until they start getting soft
3b. Add the onions and sauté onions until transparent
3c. Add the green onions and garlic and sauté for a few minutes
4. Add all the meat from 2a - 2c the seasonings and tomato sauce. Combine.
5. Gently add the rice and fold the meat mixture into the rice. You want to warm the rice. Don't stir too much as you don't want the rice to get mushy.
6. Optional: Add shrimp once the rice is heated, cover the pot and cook for 4-5 minutes depending on their size or until pink. You don't want to overcook and have rubbery shrimp.
7. Serve in large shallow bowls and garnish with parsely.`
    },
    {
...
1/2 cup dark brown (the color of chocolate) roux (1/4 cup of butter and 1/4 cup of flour)
...
4. Add the onions, celery, and bell peppers to the same pan and cook, stirring, until the vegetables are caramelized, about 15 minutes.
5. Reduce the heat to medium and add the bay leaves and the garlic. Cook, stirring, until aromatic, about 1 minute.
6. Add the tomatoes and spinach, and cook, stirring, for 1 minute. 
7. Add the stock and bring to a boil, stirring occasionally. Carefully whisk in the roux and return to a boil over medium-high heat.
8. Add the lemon zest and reserved turtle meat. 
9. Reduce the heat to medium-low and simmer for 1 hour, stirring occasionally. 
10. Add the eggs and the parsley and simmer for 45 minutes longer, or until the turtle meat is tender.
11. Add the remaining 2 teaspoons salt, cayenne and dry sherry. Stir to blend. 
12. Serve hot, with additional sherry if desired.`
    },
    {
...
1 gallon crawfish stock (see recipe below; you need to double it)
2 pounds fresh, peeled Louisiana crawfish tails with fat (the orange stuff)
2 teaspoons freshly ground black pepper (do not use your shaker, cher)
2 tablespoons salt
3 tablespoons paprika
1/2 teaspoon cayenne pepper
1 tablespoon minced garlic
About 1/2 cup of green onions (green and white parts), finely chopped 
1 bay leaf
3 cups steamed white rice

Cooking Instructions:

1. Saute the onions in the oil in a large stockpot over medium heat for 3 to 4 minutes or until translucent. 
2. Add the flour and whisk until smooth.  Constantly stir and cook until the roux is light brown.  
3. Add the stock and bring to a simmer.
4. While the mixture simmers, in a large mixing bowl combine the crawfish tails and their fat, black pepper, salt, paprika, cayenne and garlic.
5. When the stock has simmered for 10 minutes, incorporate the seasoned crawfish tails into the pot.
6. Scrape the bowl with a rubber spatula to ensure that none of the seasoning is left behind.  
7. Add the green onions and bay leaf and simmer for another 20 minutes.  
8. Discard the bay leaf and serve the crawfish etouffee with steamed rice.
...
2. Place the butter in a pyrex measuring cup and melt in microwave.
3. Spread crawfish shells and claws in a single layer on a lined baking sheet. (Use two baking sheets if necessary).
4. Pour melted butter over the shells and claws and mix together so some butter gets on all the shells.
5. Place baking sheets in preheated oven and let roast for about 20 minutes.
6. Quarter the onion and bell pepper-no need to peel or de-seed. 
7. Chop the celery into halves. 
8. Tie the herbs together in a Bouquet Garni and tie the bunch of parsley together. 
9. Place peppercorns in a small spice bag.
10. Now you are ready to make the stock.
...
3. Add the cold water, making sure to cover the shells by about 2 inches.
4. Place the stock pot over high heat and bring to a heavy boil.
5. Reduce heat to a high simmer, cover the pot and simmer for about 1 ½ hours, stirring occasionally to keep things mixed up.
6. Remove the cover and maintain a high simmer for 2 to 2 ½ hours until the liquid has reduced down to about half of the original volume.
...
13. If the stock will not be used within a couple of days, place the strained stock in freezer containers, label and freeze for put to six months.
...
You can make a seafood stock with this recipe by using crab shells instead of crawfish shells, just a different flavor profile.
`
    },
    {
        name: "Soft shell Crab Poboy",
        image: "/soft-shell-poboy.png",
        title: "My favorite poboy.",
        recipe: `Ingredients:
Good French bread
...
`
    ...
    } ,
    {
        ...
        title: "From the top left - crabmeat maison, crawfish maison, shrimp remoulade and oysters en brochette on the bottom.",
        recipe: `Cooking Instructions (easiest):
Go to Galatoire's and order Galatoire's Goute (goo-tay) and Oysters en Brochette
...
5. Chill for 2 to 4 hours. 
6. Just before serving, gently fold in the crab, taking care not to break up the lump crab. 
7. Divide the lettuce among 6 servings and top with a slice of tomato. 
8. Spoon the crawfish on top of the tomato and serve.
...
4. Season with salt and white pepper. 
5. Chill for 2 to 4 hours. 
6. Just before serving, gently fold in the crawfish, taking care not to break up the tails. 
7. Divide the lettuce among 6 servings and top with a slice of tomato. 
8. Spoon the crawfish on top of the tomato and serve.
...
1/2 cup of creole mustard or any coarse grainy brown mustard
...
4 dozen jumbo (15 count) shrimp, boiled, peeled and chilled
enough lettuce (your choice) to form a bed on a plate for the shrimp. (Prefer shredded iceberg.)
Six lemon wedges
Six sprigs of parsley

Cooking Instructions:

1. Mince the celery, green onions, parsley and onions in a food processor.
2. Add ketchup, tomato puree, Creole mustard, horseradish, red wind vinegar, paprika and Worcestershire.
3. Begin processing again and add the oil in a slow drizzel to emulsify.
4. Stop when the dressing in smooth.
5. Chill for 6 to 8 hours or overnight.
6. Correct the seasoning with additional horseradish, if desired, after the ingredients have had the opportunity to marry
7. In a large mixing bowl, add the sauce to the shrimp and toss gently to coast.
8. Place lettuce on six chilled salad plates.
9. Divide the shrimp evenly atop the lettuce and serve with a lemon wedge garnish and a sprig of parsley.ds
